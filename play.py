...
# Background
BG = pygame.transform.scale(pygame.image.load("assets/background-black.jpg"), (WIDTH, HEIGHT))
...
credits=pygame.transform.scale(pygame.image.load("assets/credits.png"), (WIDTH, HEIGHT))

#music
pygame.mixer.music.load("assets/music.wav")
dead=pygame.mixer.Sound("assets/dead.wav")
shoot=pygame.mixer.Sound("assets/shoot.wav")
dash_hit=pygame.mixer.Sound("assets/dash_hit.wav")
    ...
    while run:
        ...
        for enemy in enemies[:]:
            ...
            if collide(enemy, player):
                pygame.mixer.Sound.play(dash_hit)
                player.health -= 10
...
menu = pygame_menu.Menu(WIDTH, HEIGHT, 'Welcome to Space Fighter!!',
                       theme=pygame_menu.themes.THEME_DEFAULT)


menu.add.button('Play', start_the_game)
menu.add.button('Credits',credit)
